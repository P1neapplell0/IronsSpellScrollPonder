...
public final class PreviewProjection {
    ...
    public static void addParticle(net.minecraft.core.particles.ParticleOptions particle, boolean longDistance,
        ...
        if (embeddedDestination != null && (!isFinite(embeddedDestination)
            ...
            // Destination-bearing particles can allocate geometry proportional to their length. Never pass an
            // unprojected server-cell coordinate to Iron's client particle implementations.
